...
bool IsEmpty()
{ // membuat fungsi IsEmpty() dengan return type boolean
    if (tail == -1)
    {                // klausa if dengan kondisi tail = -1
...
bool IsFull()
{ // membuat fungsi IsFull() dengan return type boolean
    if (tail == MAX - 1)
    {                // klausa if dengan kondisi tail = MAX-1
        return true; // jika benar maka mengembalikan boolean true
    }
    else
    {
...
void Clear()
{                     // membuat procedure Clear()
    head = tail = -1; // assign variabel head dan tail dengan nilai -1
}
void View()
{ // membuat procedure View()
    if (IsEmpty())
    {                                // memanggil fungsi IsEmpty() di dalam kondisi if jika true maka
    ...
    {                  // jika false maka
        ...
        for (int a = head; a <= tail; a++)
        { // perulangan for dengan kondisi a kurang dari tail
...
int main()
{
    ...
    while (true)
    {
        ...
        else if (choice == 3)
        {
            ...
            do
            {                  // membuat perulangan do while sampai choose bernilai 5
                system("cls"); // membersihkan layar output program
                /*mencetak di layar output program
                ===== PROGRAM ANTRIAN C++ =====
                ===============================
                ...
                */
                cout << "\n\n====== PENGIRIMAN BARANG ======="
                     ...
                     << "\n===============================";
                cout << "\nChoose ! ";
                cin >> choose; // keyword cin untuk membaca inputan pada keyboard
                cout << "\n\n";
                switch (choose)
                {
                case 1:
